...
function handleLargest(large_works, layer) {
	let colector;
...
function defineCrateSizes(inner_size, layers) {
	...
	external_size.push(cub.cubing(external_size));
...
module.exports = { firstThingFirst, sameSizesChecker, handleLargest, lastStep, finishedDimensions };
