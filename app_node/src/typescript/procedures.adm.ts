...
import * as sort from "./sort.system";
import * as start from "./layer.puzzle.man";
import * as same_size_check from "./same.sizes.checker";
...
//list.
export function invert(sizes, len, new_list) {
...
export function defineCrateSizes(inner_size, layers) {
	let x;
	let z;
	let y;
	let external_size;
