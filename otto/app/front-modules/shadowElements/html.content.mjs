...
<div class="dialog" id="modal" role="dialog" aria-labelledby="title" aria-describedby="content">
	...
	<form class="padding-dialog" method="dialog" id="dialog-form">
		<iframe loading="lazy" class="container__results--open" title="Works set" src="./front-modules/shadowElements/padding_status.html" placeholder="Padding default values - L:23 D:23 H:28 - cm"></iframe>
