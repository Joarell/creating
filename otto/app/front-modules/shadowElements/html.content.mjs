...
<div class="dialog" id="modal" role="dialog" aria-labelledby="title" aria-describedby="content">
	...
	<span class="pad">*Default padding: L: 23 D: 23 H: 28 - cm</span>
	<form class="padding-dialog" method="dialog" id="dialog-form">
		<iframe loading="lazy" class="container__results--open" title="Works set" src="./front-modules/shadowElements/padding_status.html">
		</iframe>
